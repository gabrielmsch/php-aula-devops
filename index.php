...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-32" id="about">
    <h2>About</h2>
    <hr class="w3-opacity">
    <p>Isabella é aquela criança enviada por Deus para fazer o bem desde cedo. 
    Seguindo os passos de seus pais, criamos esta comunidade que tem o objetivo de arrecadar todo tipo de ajuda áquelas mais necessitadas, as crianças do continente Africano.
    </p>
